...
{
    public class DurandalSlash2 : ModProjectile
    {
        ...
        public override void CutTiles()
        {
            ...
            for (int i = 0; i < OldRot.Length; i++)
            {
                Utils.PlotTileLine(owner.Center, owner.Center + OldRot[i].ToRotationVector2() * (Radius + 25), (50 + 16) * projectile.scale, DelegateMethods.CutTiles);
            }
        }
