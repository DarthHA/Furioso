...
{
    public class RangaSlash2 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            float t = (float)Math.Sqrt(Projectile.localAI[0] / 30f);
            float len = (t - 0.5f) * 600f * Projectile.scale;
            ...
            {
                Width = 40f * (30 - Projectile.localAI[0]) / 20f;
        ...
        public void DrawAlt(SpriteBatch spriteBatch)
        {
            ...
            for (int i = 1; i < Projectile.oldPos.Length; ++i)
            {
                ...
                int width = (int)(Width * Projectile.scale);
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            {
                if (held.active && held.type == ModContent.ProjectileType<RangaHeld2>() && held.owner == Projectile.owner)
                {
                    Exist = true;
                }
            }
        ...
        {
            return targetHitbox.Distance(Projectile.Center) <= 40 * Projectile.scale;
        }
