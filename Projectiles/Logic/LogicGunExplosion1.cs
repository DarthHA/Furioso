...
namespace Furioso.Projectiles.Logic
{
    public class LogicGunExplosion1 : ModProjectile
    {
        ...
        public override void CutTiles()
        {
            ...
            Utils.PlotTileLine(projectile.Center - projectile.rotation.ToRotationVector2() * 128, projectile.Center + projectile.rotation.ToRotationVector2() * 2000, (160 + 16) * projectile.scale, DelegateMethods.CutTiles);
        }
        */
