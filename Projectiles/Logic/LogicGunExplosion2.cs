...
namespace Furioso.Projectiles.Logic
{
    public class LogicGunExplosion2 : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D tex = ModContent.Request<Texture2D>("Furioso/Projectiles/Logic/LogicGunExplosion2").Value;
        ...
        public override void CutTiles()
        {
            ...
            Terraria.Utils.PlotTileLine(Projectile.Center - Projectile.rotation.ToRotationVector2() * 250, Projectile.Center + Projectile.rotation.ToRotationVector2() * 2000, (180 + 16) * Projectile.scale, DelegateMethods.CutTiles);
        }
